...
void main() {
  ...
  test('should return LexicalEntryModel object after fromJson', () {
    final Map<String, dynamic> jsonData = json.decode(
      fixture(fixtureFileName),
    );
    expect(LexicalEntryModel.fromJson(jsonData), tLexicalEntryModel);
  });

  test('should return json object after toJson', () {
    final Map<String, dynamic> jsonData = tLexicalEntryModel.toJson();
    expect(jsonData, json.decode(fixture(fixtureFileName)));
  });
}

LexicalEntryModel _buildTestModel() {
