...
void main() {
  ...
  test('should return HeadwordEntryModel object after fromJson', () {
    final Map<String, dynamic> jsonData = json.decode(
      fixture(fixtureFileName),
    );
    expect(HeadwordEntryModel.fromJson(jsonData), tHeadwordEntry);
  });

  test('should return json object after toJson', () {
    final Map<String, dynamic> jsonData = tHeadwordEntry.toJson();
    expect(jsonData, json.decode(fixture(fixtureFileName)));
  });
}

HeadwordEntryModel _buildTestModel() {
